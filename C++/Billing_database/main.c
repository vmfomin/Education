...
int main() {
  ...
  int command = -1;
  while (command != 0) {
    puts("\x1b[2J============= Биллинговая база оператора связи =============");
    ...
    switch (command) {
      ...
      case 2:  // удаление данных о клиенте
        ...
        removeClient(name);
        break;
      case 3:  // TODO чтение данных о клиенте
      ...
      case 4:  // TODO редактирование данных о клиенте
        // Добавление и удаление услуги, чтение и редактирование
        // данных о ней
        break;
      ...
      case 6:  // TODO Получение списка клиентов по характеристикам их счетов
        break;
      case 7:  // TODO Получение списка всех клиентов
        break;
      case 0:
