...
int main() {
  ...
  while (command != 0) {
    ...
    puts("Введите 5, чтобы добавить или удалить данные о клиенте о клиенте;");
    puts("Введите 6, чтобы добавить или удалить услуги;");
    puts(
        "Введите 7, чтобы получить список клиентов по оказываемым услугам в "
        "заданном интервале времени;");
    puts(
        "Введите 8, чтобы получить список клиентов по характеристикам их "
        "счетов;");
    puts("Введите 9, чтобы получить список всех клиентов;");
    ...
    switch (command) {
      ...
      case 4:  // TODO редактирование данных о клиенте
        ...
        editClient(name);
        break;
      case 5:  // TODO Добавление и удаление данных о клиенте (контакты)
        break;
      case 6:  // TODO Добавление и удаление услуги
        break;
      case 7:  // TODO Получение списка клиентов в заданном интервале времени
        ...
        break;
      case 8:  // TODO Получение списка клиентов по характеристикам их счетов
        break;
      case 9:  // Получение списка всех клиентов
